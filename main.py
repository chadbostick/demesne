...
from mechanics.faction_utils import empty_tokens, build_faction_data, compute_goal_costs, compute_coalitions
...
def _vprint(*args, **kwargs):
    ...
    # compute_goal_costs moved to mechanics/faction_utils.py


    # compute_coalitions, _empty_tokens, build_faction_data moved to mechanics/faction_utils.py
